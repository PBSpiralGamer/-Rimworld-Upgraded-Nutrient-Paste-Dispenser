...
namespace DispenserCode
{
    [DefOf]
    public static class DefOfUpgradedPasteMeal
    {
        public static ThingDef MealUpgradedNutrientPaste;
    }

    public class Building_UpgradedNutrientPasteDispenser : Building
    {
        ...
        public virtual ThingDef DispensableDef => DefOfUpgradedPasteMeal.MealUpgradedNutrientPaste;
        ...
        public virtual Thing TryDispenseFood()
        {
            ...
            Thing thing2 = ThingMaker.MakeThing(DefOfUpgradedPasteMeal.MealUpgradedNutrientPaste);
